...
# Definim categoriile posibile pentru parfumuri
CATEGORIES = [
    ('floral', 'Floral'),
    ('citric', 'Citric'),
    ('lemnos', 'Lemnos'),
...
class Parfum(models.Model):
    ...
    def str(self):
        return f'Perfum(title={self.name}, category={self.category}, description={self.description}, price={self.price}, slug={self.slug})'
...
class OrderItem(models.Model):
    ...
    book = models.ForeignKey(Parfum, on_delete=models.CASCADE, null=True)
